...
| Tipo de controlador  | $k_{p}$  | $T_{i}$  | $T_{d}$  |
|---|---|---|---|
|    | $\frac{1}{K} * \frac{\tau }{t_{o}} * (\frac{3\tau + t_{o}}{3\tau})$  |   |   |
|    | $\frac{1}{K} * \frac{\tau }{t_{o}} * (\frac{10.8\tau + t_{o}}{12\tau})$  | \frac{30 + 3(\frac{t_{0}}{\tau })}{9 + 20(\frac{t_{0}}{\tau })} * \tau   |   |
|    | $\frac{1}{K} * \frac{\tau }{t_{o}} * (\frac{16\tau + 3t_{o}}{12\tau})$  | $2t_{o}$  | $0.5t_{o}$  |
