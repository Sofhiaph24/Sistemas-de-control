...
![](Imagenes/MZiegler&Nichols.PNG).

Figura 8. Meto de Ziegler & Nichols

![](Imagenes/Perturbacion1/4.PNG).

Figura 9. Caida de la respuesta ante perturbaciones

![](Imagenes/CambioReferencia1/4.PNG).

Figura 10. Caida de la respuesta ante cambios en la referencia

### 6.2. Método de Cohen-coon

![](Imagenes/MCohe-coon.PNG).

Figura 11.Metodo Cohe-Coon

### 6.3. Método de coeficiente de ajustabilidad

![](Imagenes/MCoeficientedeajustabilidad.PNG).

Figura 12. PID por coeficiente de ajustabilidad

### 6.4. Método Smith (PID)

![](Imagenes/MSmithPI.PNG).

Figura 13.Metodo Smith PI

![](Imagenes/MSmithPID.PNG).

Figura 14.Metodo Smith PID
